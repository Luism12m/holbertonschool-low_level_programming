...
What is a function prototype (read only Function prototype )
What is the purpose of a function prototype?
C - Header Files (stop before Once-Only  paragraph)
Learning Objectives
...
You are not allowed to use the standard library. Any use of functions like printf, puts, You are allowed to use _putchar
...
More Info
You do not have to understand the call by reference (address), stack, static variables, recursions or arrays, yet.DonwondonwondonetcHeadersthe paragraphthe 